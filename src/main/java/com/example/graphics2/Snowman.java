...
public class Snowman extends Application {
    public void start (Stage primaryStage) {
        ...
        middleButton.setFill(Color.HOTPINK);
        ...
        Group snowman = new Group(name, base, middle, head, leftEye, rightEye, mouth, topButton,middleButton, bottomButton, leftArm, rightArm, hat);
        snowman.setTranslateX(40);
        ...
        /* Rectangle rect= new Rectangle (30, 20, 100, 200);
