...
public class StyleOptionsPane extends VBox
{
    ...
    {
        phrase = new Text("Say it with style!"); phrase.setFont(new Font("Helvetica", 36));
        boldCheckBox = new CheckBox("Bold"); boldCheckBox.setOnAction(this::processCheckBoxAction); italicCheckBox = new CheckBox("Italic"); italicCheckBox.setOnAction(this::processCheckBoxAction);
        HBox options = new HBox(boldCheckBox, italicCheckBox); options.setAlignment(Pos.CENTER); options.setSpacing(20); // between the check boxes
    ...
    {
        FontWeight weight = FontWeight.NORMAL; FontPosture posture = FontPosture.REGULAR;
